<div align="center">
<h1>GoF 设计模式 🎯</h1>
<a href="https://dotnet.microsoft.com/"><img src="https://img.shields.io/badge/.NET-11.0-purple?logo=dotnet&logoColor=fff" /></a>
<a href="https://learn.microsoft.com/dotnet/csharp/"><img src="https://img.shields.io/badge/C%23-13.0-blue?logo=csharp&logoColor=fff" /></a>
...
本仓库以现代 `C#/ .NET 11` 系统化实现 GoF 23 种设计模式，兼顾**可运行代码**与**深度讲解**，帮助开发者从"知道"走向"会用"。
...
> 在深入 23 种设计模式之前，建议先阅读以下两篇基础文档——它们是理解所有模式的"前置知识"。

| 文档                                                    | 说明                                                             |
| ------------------------------------------------------- | ---------------------------------------------------------------- |
| 🧱 [SOLID 五大设计原则](./docs/SOLID%20五大设计原则.md) | 面向对象设计的基石——单一职责、开闭、里氏替换、接口隔离、依赖倒置 |
| 📐 [UML 类图五大关系](./docs/UML%20类图五大关系.md)     | 读懂类图的必修课——依赖、关联、聚合、组合、泛化/实现              |
